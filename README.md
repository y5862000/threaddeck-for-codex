...
| Fast mode | — | Release to toggle Fast mode in the current task's Codex composer; a filled green bolt means Fast, an outlined neutral bolt means standard, and text appears only when the state needs attention |
