...
ThreadDeck intentionally does not try to replace the richer Codex Micro control surface. Its niche is a glanceable, physical task monitor: pinned/recent task titles, working/completed state, timing, reasoning and speed cues, completion pulses, and one-tap navigation.
