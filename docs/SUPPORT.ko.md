...
버그 신고 양식을 사용하고 macOS, Stream Deck, Codex, ThreadDeck 버전을 적어주세요. 화면을 첨부하기 전 비공개 작업 제목을 예시 문구로 바꿉니다.

전용 물리 버튼이나 표시 상태가 왜 필요한지 실제 작업 흐름을 설명한 기능 요청을 환영합니다. 일반적인 Codex 또는 Stream Deck 지원은 각 제품 제공자에게 문의해주세요.

보안 문제는 [보안 안내](SECURITY.ko.md)에 따라 비공개로 신고해야 합니다.
