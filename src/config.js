...
const VOICE_SUBMIT_VERIFY_DELAYS_MS = [120, 180, 260, 380, 560];
const VOICE_START_VERIFY_MS = 1_500;
const VOICE_COMPLETE_DISPLAY_MS = 1_100;
const VOICE_ERROR_DISPLAY_MS = 1_300;
const VISUAL_STATE_TRANSITION_MS = 260;
const VISUAL_FEEDBACK_ATTACK_MS = 140;
const VISUAL_FEEDBACK_RELEASE_MS = 320;
const VISUAL_ISSUE_TRANSITION_MS = 360;
const VISUAL_USAGE_TRANSITION_MS = 420;
const VISUAL_THEME_TRANSITION_MS = 360;
