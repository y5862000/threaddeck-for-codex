...
| <img src="docs/media/completed-task-key.png" width="104" alt="완료된 작업 버튼"> | 체크와 멈춘 시간은 최근에 관찰한 턴이 완료됐다는 뜻입니다. 해당 턴이 빠른 서비스를 사용했다면 번개도 계속 표시됩니다. 나중에 같은 작업을 다시 열어도 확정된 완료 시간은 덮어쓰지 않습니다. |
