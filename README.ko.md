...
<p align="center"><a href="README.md">English (기본)</a> · <strong>한국어</strong> · <a href="docs/INSTALL.ko.md">설치</a> · <a href="docs/PROFILE.ko.md">Neo 프로파일</a> · <a href="#길게-누르면-달라지는-버튼">제스처</a> · <a href="https://github.com/y5862000/threaddeck-for-codex/releases">다운로드</a></p>
...
<p align="center"><img src="docs/media/neo-preview.png" width="680" alt="Stream Deck Neo용 ThreadDeck for Codex 추천 프로파일"></p>

플러그인은 현재 유지되는 3페이지 **ThreadDeck for Codex** 프로파일을 자동으로 설치합니다. 릴리스에는 복구·수동 가져오기용 `threaddeck-for-codex-neo.streamDeckProfile`도 별도로 첨부합니다. 이미 유지되는 프로파일이 Stream Deck에 있다면 독립 파일을 가져올 때 의도적으로 복사본이 하나 더 생깁니다. 대시보드·작업·미디어의 정확한 배치는 [Neo 추천 프로파일 안내](docs/PROFILE.ko.md)에서 확인하세요.
...
포함된 추천 프로필은 3페이지이며 Stream Deck에서 자유롭게 재배치할 수 있습니다. GitHub 릴리스마다 독립 복사본도 첨부하며 [시각적 배치와 가져오기 안내](docs/PROFILE.ko.md)에서 자세히 설명합니다.
